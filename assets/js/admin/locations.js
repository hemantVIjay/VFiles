(function ($) {
    ...
    function listTickets(page_num){
        ...
        $.ajax({
            type: 'POST',
            url: baseUrl+'admin/locationss/list_tickets_ajax/'+page_num,
            data:form.serialize(),
            dataType: 'json',
            async: false,
            beforeSend: function () {
    ...
    function viewTicket(ticket_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/view",
            data: {
                ticket_id: ticket_id
            },
            dataType: 'json',
                ...
                if (data.success) {
                    ...
                    replyTicketForm.validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: baseUrl + "admin/locations/reply",
                                data: form_data,
                                dataType: 'json',
                                cache: false,
                                contentType: false,
    ...
    function assignTicket(ticket_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/assign",
            data: {
                ticket_id: ticket_id
            },
            dataType: 'json',
                ...
                if (data.success) {
                    ...
                    assignTicketForm.validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: baseUrl + "admin/locationss/assign_ticket_action",
    ...
    function completeTicket(ticket_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/completed",
            data: {
                ticket_id: ticket_id
            },
            dataType: 'json',
    ...
    function confirmCompleteTicket(ticket_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locationss/mark_ticket_completed_action",
            data: {
                ticket_id: ticket_id
            },
            dataType: 'json',
    ...
    function incompleteTicket(ticket_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/incompleted",
            data: {
                ticket_id: ticket_id
            },
            dataType: 'json',
    ...
    function confirmIncompleteTicket(ticket_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locationss/mark_ticket_incompleted_action",
            data: {
                ticket_id: ticket_id
            },
            dataType: 'json',
    ...
    function deleteTicket(ticket_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/delete",
            data: {
                ticket_id: ticket_id
            },
            dataType: 'json',
    ...
    function confirmDeleteTicket(ticket_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locationss/delete_ticket_action",
            data: {
                ticket_id: ticket_id
            },
            dataType: 'json',
    ...
    function listCategories(page_num){
        $.ajax({
            type: 'POST',
            //url: baseUrl+'admin/locations/list_categories_ajax/'+page_num,
            url: baseUrl+'admin/locations/list_locations/'+page_num,
            data:{
                page_num:page_num
            },
            dataType: 'json',
    ...
    function viewCategory(category_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/category/view",
            data: {
    ...
    function addLocation(){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/add_location",
            data: {
                category_id: 0
            },
            dataType: 'json',
				...
				if (data.success) {
                    ...
                    addCategoryForm.validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: baseUrl + "admin/locations/create_location",
	...
	function addZoneLocation(id){
        //show loader
        sidePanelLoader.show();
        //ajax submit
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/add_zonelocation",
            data: {
                category_id: id
            },
            dataType: 'json',
				...
				if (data.success) {
                    ...
                    addCategoryForm.validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: baseUrl + "admin/locations/create_zoneLocation",
                                data: addCategoryForm.serialize(),
                                dataType: 'json',
                                async: false,
                                beforeSend: function() {
    ...
    function addZone(){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/add_zone",
            data: {
                category_id: 0
            },
            dataType: 'json',
				...
				if (data.success) {
                    ...
                    addCategoryForm.validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: baseUrl + "admin/locations/create_zone",
                                data: addCategoryForm.serialize(),
                                dataType: 'json',
                                async: false,
                                beforeSend: function() {
    ...
    function addCategory(){
        ...
        $.ajax({
            type: "POST",
            //url: baseUrl+"admin/locations/category/add",
            url: baseUrl+"admin/locations/add",
            data: {
                category_id: 0
            },
            dataType: 'json',
                ...
                if (data.success) {
                    ...
                    addCategoryForm.validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: baseUrl + "admin/locations/category/create",
                                data: addCategoryForm.serialize(),
                                dataType: 'json',
                                async: false,
                                beforeSend: function() {
    ...
    function editCategory(category_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/category/edit",
            data: {
                category_id: category_id
            },
            dataType: 'json',
                ...
                if (data.success) {
                    ...
                    editCategoryForm.validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: baseUrl + "admin/locations/category/update",
    ...
    function categoryOrdering(){
        $.ajax({
            type: 'POST',
            url: baseUrl+'admin/locations/category/ordering',
            data: {
                category:0
            },
            dataType: 'json',
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    categoryOrderingButton.on('click',function(){
                        ...
                        $.ajax({
                            type: "POST",
                            url: baseUrl + "admin/locations/category/update_ordering",
                            data: {
    ...
    function deleteCategory(category_id){
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+"admin/locations/category/delete",
            data: {
                category_id: category_id
            },
            dataType: 'json',
                    ...
                    if(data.exist){
                        ...
                        transferCategoryForm.validate({
                            ...
                            submitHandler: function(form) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: baseUrl + "admin/locationss/delete_category_action",
