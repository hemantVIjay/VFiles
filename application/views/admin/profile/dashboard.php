...
<div class="row">
    <div class="col-md-6 col-lg-3">
        <div class="widget-small secondary coloured-icon mb30"><i class="icon feather icon-file-text"></i>
            <div class="info">
                <h5></i><?= $this->lang->line("text_available_stock"); ?></h5>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="widget-small secondary coloured-icon mb30"><i class="icon feather icon-life-buoy"></i>
            <div class="info">
                <h5><?= $this->lang->line("text_tickets"); ?></h5>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="widget-small secondary coloured-icon mb30"><i class="icon feather icon-users"></i>
            <div class="info">
                <h5><?= $this->lang->line("text_today"); ?> <?= $this->lang->line("orders"); ?></h5>
...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="tile mb30">
            <div class="tile-title">
                <h3><?= $this->lang->line("text_latest_orders"); ?></h3>
            </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">   
        <div class="tile mb30">
            <div class="tile-title">
                <h3><?= $this->lang->line("text_latest_deliveries"); ?></h3>
            </div>
            <div class="tile-content">
