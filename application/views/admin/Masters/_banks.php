<div class="row">
   <div class="col-12 col-xl-4">
      <div class="card">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url('admin/masters/create_bank'); ?>" enctype="multipart/form-data" accept-charset="utf-8">
               <div class="mb-3">
                  <label class="form-label">Bank Name</label>
                  <input name="bank_name" type="text" class="form-control" placeholder="Enter Bank here...">
               </div>
               <div class="mb-3">
                  <label class="form-label w-100">Icon</label>
                  <input type="file" name="bank_icon" accept=".svg" required>
