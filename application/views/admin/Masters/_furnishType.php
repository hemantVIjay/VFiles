<div class="row">
   <div class="col-12 col-xl-4">
      <div class="card">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url('admin/masters/create_furnishType'); ?>" enctype="multipart/form-data" accept-charset="utf-8">
               <div class="mb-3">
   ...
   <div class="col-12 col-xl-8">
      <div class="card">
         <div class="card-header">
            <h5 class="card-title">Furnish Types Lists</h5>
         </div>
		 ...
		 <table class="table" style="width:100%;height:100%;">
            <thead>
               <tr>
                  ...
                  <th style="width:55%;">Furnish Type</th>
