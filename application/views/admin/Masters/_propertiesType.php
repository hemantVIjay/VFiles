<div class="row">
   <div class="col-12 col-xl-4">
      <div class="card">
         <div class="card-header">
            <h5 class="card-title">Add Properties Type</h5>
         </div>
         <div class="card-body">
            <form method="POST" action="<?= base_url('admin/masters/create_propertyType'); ?>" enctype="multipart/form-data" accept-charset="utf-8">
               <div class="mb-3">
   ...
   <div class="col-12 col-xl-8">
      <div class="card">
         <div class="card-header">
            <h5 class="card-title">Property Types Lists</h5>
         </div>
		 ...
		 <table class="table" style="width:100%;height:100%;">
            <thead>
               <tr>
                  ...
                  <th style="width:55%;">Property Type</th>
                  <th class="d-none d-md-table-cell" style="width:25%">Icon</th>
                  <th>Actions</th>
               </tr>
            </thead>
            <tbody>
               <?php $i=0; if(!empty($propertyTypes)){ 
			   foreach($propertyTypes as $key=>$row){ $cls = ($i % 2); ?>
