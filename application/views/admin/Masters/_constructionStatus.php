<div class="row">
   <div class="col-12 col-xl-4">
      <div class="card">
         <div class="card-header">
            <h5 class="card-title">Add Property Status</h5>
         </div>
         <div class="card-body">
            <form method="POST" action="<?= base_url('admin/masters/create_constructionStatus'); ?>" enctype="multipart/form-data" accept-charset="utf-8">
               <div class="mb-3">
   ...
   <div class="col-12 col-xl-8">
      <div class="card">
         <div class="card-header">
            <h5 class="card-title">Property Status Lists</h5>
         </div>
